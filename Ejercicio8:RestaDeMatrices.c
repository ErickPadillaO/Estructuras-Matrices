...
void restarMatrices(int matriz1[][COLUMNAS], int matriz2[][COLUMNAS], int filas,int columnas){
	for(int i = 0; i < filas; i++){
		for(int j = 0; j < columnas; j++){
...
int main(){
	...
	//Restar matrizA y matrizB
	restarMatrices(matrizA, matrizB, totalDeFilas, totalDeColumnas);
